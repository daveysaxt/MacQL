...
vml inline Cond ccT(void);
vml inline Cond ccF(void);
vml inline Cond ccHI(void);
vml inline Cond ccLS(void);
vml inline Cond ccCC(void);
vml inline Cond ccCS(void);
vml inline Cond ccNE(void);
vml inline Cond ccEQ(void);
vml inline Cond ccVC(void);
vml inline Cond ccVS(void);
vml inline Cond ccPL(void);
vml inline Cond ccMI(void);
vml inline Cond ccGE(void);
vml inline Cond ccLT(void);
vml inline Cond ccGT(void);
vml inline Cond ccLE(void);
